...
require_once './php/selectMedical.php';
				...
				<div class="card-wrapper">
					<div class="card fat mt-5 ">
						<div class="card-body">
							...
							<h5 class="card-title">إنشاء حساب متبرع</h5>
							<h7 class="card-title "><?php if (isset($_SESSION['message'])) echo $_SESSION['message'] ?></h7>
							<form method="POST" action="php/register.php" class="my-login-validation" novalidate="" style="    text-align: right;">
								...
								<div class="form-group">
									<label for="blood_type">فصيلة دمك</label>
									<select class="form-control form-control-range" name="blood_type" id="blood_type">
										<option selected>إختار فصيلة الدم</option>
										<option value="O+">O+</option>
										<option value="A+">A+</option>
										<option value="A-">A-</option>
									</select>
									<div class="invalid-feedback">
										يجب عليك إختيار فصيلة دمك؟
									</div>
								</div>
								...
								<div class="form-group">
									...
									<select class="form-control form-control-file" name="medical" id="medical">
										<option selected>إختار جهة التبرع</option>
										<?php
								...
								<div class="form-group">
									<div class="text-center">
										<button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#modalRegular">حدد موقع بواسطة خرائط جوجل</button>
									</div>
										...
										<div class="modal-dialog modal-lg" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer justify-content-center">
													<button type="button" class="btn btn-info btn-md ml-2">حفظ الموقع<i class="fas fa-map-marker-alt ml-1"></i></button>
													<button type="button" class="btn btn-outline-info btn-md" data-dismiss="modal">إغلاق <i class="fas fa-times ml-1"></i></button>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="form-group">
									<div class="custom-checkbox custom-control">
										...
										<label for="agree" class="custom-control-label">أنا أوافق على <a href="#">الأحكام والشروط</a></label>
										<div class="invalid-feedback">
								...
								<div class="mt-4 text-center">
									...
									<span>أو</span>
									<a class="mr-1" href="../Hospital-Auth/index.php">تسجيل حساب جهة صحية </a>
								</div>
							</form>
						</div>
					</div>
