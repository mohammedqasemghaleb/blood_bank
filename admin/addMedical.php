            ...
            <div class="settings-page m-20">
                ...
                <div class="bg-white rad-10" style="padding: 25px;">
                    ...
                    <div class="col-lg-6" style="box-shadow: 0px 0px 15px -4px #938e8e; padding: 15px 18px ; border-radius: 8px;">
                        <form action="php/addMedical.php" method="post">
                            <div class="col-md-12 mb-3">
                                <label for="validationServerUsername">إسم الجهه الصحية</label>
                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-5">
                                    <button type="submit" name="addMedical" class="btn btn-danger w-100 mt-2" style="background-color: #ad0101;">حفظ </button>
                                </div>
                            </div>
                        </form>
